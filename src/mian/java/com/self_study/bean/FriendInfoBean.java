...
public class FriendInfoBean implements Serializable{
	...
	public FriendInfoBean(String id, String userid, String targetcontent, String current_state,
	...
	public String toString() {
		return "FriendInfoBean [id=" + id + ", userid=" + userid + ", targetcontent=" + targetcontent
				+ ", current_state=" + current_state + ", target_description=" + target_description + "]";
	}
	@Override
	public int hashCode() {
		final int prime = 31;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FriendInfoBean other = (FriendInfoBean) obj;
